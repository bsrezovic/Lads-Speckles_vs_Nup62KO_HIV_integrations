...
The results are pretty similar: around 82% of Robson LADs are overlapping with Belmont LADs,
and around 93% of Belmont LADs overlap Robson LADs.
...
gr2 <- makeGRangesFromDataFrame(blads2, keep.extra.columns = TRUE)
...
```{r,echo = FALSE}
# load in the presumed speckle associated datums
