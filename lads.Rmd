...
ngenic <- ngenic[!group%in%c("Resting_mock","Resting_KO153","Activated_mock","Activated_KO153"),]
...
over5[,totals:= ifelse(count_total <2,"unique (4335)",
                ifelse(count_total >=2 & count_total <10, "2-10 (18594)",
                ifelse(count_total <20 & count_total >=10,">10 (4437)",
                ifelse(count_total >=20 & count_total < 40,">=20 (2185)",
                ifelse(count_total >=40, ">=40 (585)","error")) )))]
